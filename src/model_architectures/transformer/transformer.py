'''
Modified Vision transformer from torchvision. Taken from https://github.com/pytorch/vision/blob/main/torchvision/models/vision_transformer.py
'''
...
from model_architectures.transformer.utils import _log_api_usage_once
from model_architectures.transformer.misc import Conv2dNormActivation, MLP
...
class VisionTransformer(nn.Module):
    ...
    def loss(self, patch, neighbor, distant, margin=0.1, l2=0):
        ...
        z_p, z_n, z_d = (self.forward(patch), self.forward(neighbor),
            self.forward(distant))
        
        return self.triplet_loss(z_p, z_n, z_d, margin=margin, l2_reg=l2)

def make_ViT(image_size = 50, z_dim=512):
    """
